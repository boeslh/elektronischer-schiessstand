...
func (a *APIServer) Run(ctx context.Context) error {
	...
	mux.HandleFunc("GET /preisschiessen-anmeldung", a.serveHTMLGated(webSub, "preisschiessen-anmeldung.html", "preisschiessen"))
	mux.HandleFunc("GET /preisschiessen-kasse", a.serveHTMLGated(webSub, "preisschiessen-kasse.html", "preisschiessen"))
	mux.HandleFunc("GET /preisschiessen-teilnehmer", a.serveHTMLGated(webSub, "preisschiessen-teilnehmer.html", "preisschiessen"))
	...
	mux.HandleFunc("POST /api/preisschiessen/{id}/teilnehmer/{tid}/warenkorb/buchen", a.h(a.postBuchWarenkorb))
	...
	mux.HandleFunc("POST /api/preisschiessen/{id}/scheiben-einheiten/{ksid}/stand", a.h(a.postAssignPreisschiessenLane))
